        ...
        <section className="about" id="about">
            <div className="container about-grid">
                ...
                <div className="about-right">
                    <h2 className="display">Great design is<br className="about-br-main" /> more<br className="about-br-tp" /> than <span className="serif-italic" style={{ fontSize: '78px' }}>aesthetics.</span></h2>
                    ...
                    <div className="about-media-mobile">
                        <img src="/images/Laptop Image.png" alt="MRK design work on a laptop" />
                    </div>
