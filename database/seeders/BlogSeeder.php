...
class BlogSeeder extends Seeder
{
    ...
    {
        // Author (reuse admin if present, else create one)
        ...
        $posts = [
            [
                ...
                'featured_image' => 'blog/seo-guide.jpg',
...
<p>For small businesses, <strong>local SEO</strong> is where the money is. Claim and fully optimize your Google Business Profile, gather genuine customer reviews, and keep your name, address, and phone number (NAP) consistent across every directory. Local pack rankings drive calls and foot traffic fast.</p>
...
<p>SEO is a marathon, not a sprint — but the compounding returns are unmatched. Implement these strategies consistently and you'll build a steady stream of qualified organic traffic. Need help? <strong>MRK Design Agency</strong> builds fast, SEO-optimized websites engineered to rank and convert.</p>
HTML,
            ],
            [
                ...
                'featured_image' => 'blog/web-design-conversion.png',
...
<p>Every second of load time can cut conversions by up to 20%. Compress images, use modern formats, lazy-load assets, and minimize scripts. Fast sites rank better and convert better.</p>
...
<p>Conversion-focused web design blends psychology, data, and craft. At <strong>MRK Design Agency</strong> we design and build custom websites engineered to convert — beautiful, fast, and built to grow your business.</p>
HTML,
            ],
            [
                ...
                'featured_image' => 'blog/branding-identity.png',
...
<p>Brand identity is the full system of visual and verbal elements that shape how people perceive you. It includes:</p>
<ul>
  <li><strong>Logo and variations</strong> for every context</li>
  <li><strong>Color palette</strong> that triggers the right emotions</li>
  <li><strong>Typography</strong> that reinforces personality</li>
  <li><strong>Imagery and graphic style</strong></li>
  <li><strong>Brand voice and messaging</strong></li>
  <li><strong>Guidelines</strong> that keep everything consistent</li>
</ul>

<h2>Why a Complete Brand Identity Matters</h2>
<p>Consistent branding across all touchpoints can increase revenue by up to 23%. A strong brand identity helps you:</p>
<ul>
  <li><strong>Stand out</strong> in a crowded market</li>
  <li><strong>Build trust and recognition</strong> with your audience</li>
  <li><strong>Command premium prices</strong> by signaling quality</li>
  <li><strong>Create emotional connections</strong> that drive loyalty</li>
</ul>
...
<p>Your brand is the promise you make to your customers. At <strong>MRK Design Agency</strong> we craft complete brand identities — from logo design to full visual systems — that make businesses unforgettable. Ready to build a brand that stands out? Let's talk.</p>
HTML,
            ],
        ];
        ...
        foreach ($posts as $i => $data) {
            ...
            $catIds = collect($data['categories'])->map(fn ($c) => $cats[$c]->id)->all();
            $tagIds = collect($data['tags'])->map(fn ($t) => $tag($t)->id)->all();
